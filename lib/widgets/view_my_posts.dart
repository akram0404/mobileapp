              ...
              Expanded(
                child: ListView(
                  ...
                  children: snapshot.data.docs.map((document) {
                    ...
                    String savedBy = document["image"];
                    String reportedBy = document["ingredients"];
                    String reasons = document["title"];
                    ...
                    showAlertDialog(BuildContext context) {
                      ...
                      Widget spamButton = FloatingActionButton(
                        child: Text(
                          "Spam",
                      ...
                      Widget inpButton = FloatingActionButton(
                        child: Text(
                          "Inappropriate",
                          style: TextStyle(color: Colors.redAccent),
                        ),
